...
func (*EventProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{0}
}
...
func (*EnableBrokerFunInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{1}
}
...
func (*AuthenticateInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{2}
}
...
func (*MasterCertificateInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{3}
}
...
func (*MasterAuthorizedInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{4}
}
...
func (*MasterBrokerAuthorizedInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{5}
}
...
func (*DataStorePath) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{6}
}
...
func (*TopicRmvInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{7}
}
...
func (*DefaultConfigInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{8}
}
...
func (*TopicConfigInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{9}
}
...
func (*BrokerConfigInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{10}
}
...
func (*BrokerPolicyInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{11}
}
...
func (*BrokerStatusInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{12}
}
...
func (*BrokerOperateInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{13}
}
...
type RegisterRequestC2M struct {
	...
	TopicList []string `protobuf:"bytes,4,rep,name=topicList,proto3" json:"topicList,omitempty"`
	// consumerId@group-brokerId:host:port-topic:partitionId
	SubscribeInfo        []string               `protobuf:"bytes,5,rep,name=subscribeInfo,proto3" json:"subscribeInfo,omitempty"`
	TopicCondition       []string               `protobuf:"bytes,6,rep,name=topicCondition,proto3" json:"topicCondition,omitempty"`
	RequireBound         bool                   `protobuf:"varint,7,opt,name=requireBound,proto3" json:"requireBound,omitempty"`
	SessionTime          int64                  `protobuf:"varint,8,opt,name=sessionTime,proto3" json:"sessionTime,omitempty"`
	SessionKey           string                 `protobuf:"bytes,9,opt,name=sessionKey,proto3" json:"sessionKey,omitempty"`
	TotalCount           int32                  `protobuf:"varint,10,opt,name=totalCount,proto3" json:"totalCount,omitempty"`
	RequiredPartition    string                 `protobuf:"bytes,11,opt,name=requiredPartition,proto3" json:"requiredPartition,omitempty"`
	NotAllocated         bool                   `protobuf:"varint,12,opt,name=notAllocated,proto3" json:"notAllocated,omitempty"`
	SelectBig            bool                   `protobuf:"varint,13,opt,name=selectBig,proto3" json:"selectBig,omitempty"`
	GroupFlowCheckId     int64                  `protobuf:"varint,14,opt,name=groupFlowCheckId,proto3" json:"groupFlowCheckId,omitempty"`
	DefFlowCheckId       int64                  `protobuf:"varint,15,opt,name=defFlowCheckId,proto3" json:"defFlowCheckId,omitempty"`
	SsdStoreId           int64                  `protobuf:"varint,16,opt,name=ssdStoreId,proto3" json:"ssdStoreId,omitempty"`
	QryPriorityId        int32                  `protobuf:"varint,17,opt,name=qryPriorityId,proto3" json:"qryPriorityId,omitempty"`
	AuthInfo             *MasterCertificateInfo `protobuf:"bytes,18,opt,name=authInfo,proto3" json:"authInfo,omitempty"`
	JdkVersion           string                 `protobuf:"bytes,19,opt,name=jdkVersion,proto3" json:"jdkVersion,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (*RegisterRequestC2M) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{14}
}
...
type RegisterResponseM2C struct {
	...
	TopicInfo            []string              `protobuf:"bytes,4,rep,name=topicInfo,proto3" json:"topicInfo,omitempty"`
	NotAllocated         bool                  `protobuf:"varint,5,opt,name=notAllocated,proto3" json:"notAllocated,omitempty"`
	DefFlowCheckId       int64                 `protobuf:"varint,6,opt,name=defFlowCheckId,proto3" json:"defFlowCheckId,omitempty"`
	DefFlowControlInfo   string                `protobuf:"bytes,7,opt,name=defFlowControlInfo,proto3" json:"defFlowControlInfo,omitempty"`
	GroupFlowCheckId     int64                 `protobuf:"varint,8,opt,name=groupFlowCheckId,proto3" json:"groupFlowCheckId,omitempty"`
	GroupFlowControlInfo string                `protobuf:"bytes,9,opt,name=groupFlowControlInfo,proto3" json:"groupFlowControlInfo,omitempty"`
	SsdStoreId           int64                 `protobuf:"varint,10,opt,name=ssdStoreId,proto3" json:"ssdStoreId,omitempty"`
	QryPriorityId        int32                 `protobuf:"varint,11,opt,name=qryPriorityId,proto3" json:"qryPriorityId,omitempty"`
	AuthorizedInfo       *MasterAuthorizedInfo `protobuf:"bytes,12,opt,name=authorizedInfo,proto3" json:"authorizedInfo,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (*RegisterResponseM2C) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{15}
}
...
func (*RegisterRequestB2M) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{16}
}
...
func (*RegisterResponseM2B) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{17}
}
...
func (*HeartRequestB2M) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{18}
}
...
func (*HeartResponseM2B) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{19}
}
...
type HeartRequestC2M struct {
	ClientId             string                 `protobuf:"bytes,1,opt,name=clientId,proto3" json:"clientId,omitempty"`
	GroupName            string                 `protobuf:"bytes,2,opt,name=groupName,proto3" json:"groupName,omitempty"`
	SubscribeInfo        []string               `protobuf:"bytes,3,rep,name=subscribeInfo,proto3" json:"subscribeInfo,omitempty"`
	ReportSubscribeInfo  bool                   `protobuf:"varint,4,opt,name=reportSubscribeInfo,proto3" json:"reportSubscribeInfo,omitempty"`
	Event                *EventProto            `protobuf:"bytes,5,opt,name=event,proto3" json:"event,omitempty"`
	DefFlowCheckId       int64                  `protobuf:"varint,6,opt,name=defFlowCheckId,proto3" json:"defFlowCheckId,omitempty"`
	GroupFlowCheckId     int64                  `protobuf:"varint,7,opt,name=groupFlowCheckId,proto3" json:"groupFlowCheckId,omitempty"`
	SsdStoreId           int64                  `protobuf:"varint,8,opt,name=ssdStoreId,proto3" json:"ssdStoreId,omitempty"`
	QryPriorityId        int32                  `protobuf:"varint,9,opt,name=qryPriorityId,proto3" json:"qryPriorityId,omitempty"`
	AuthInfo             *MasterCertificateInfo `protobuf:"bytes,10,opt,name=authInfo,proto3" json:"authInfo,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (*HeartRequestC2M) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{20}
}
...
type HeartResponseM2C struct {
	...
	ErrCode              int32                 `protobuf:"varint,2,opt,name=errCode,proto3" json:"errCode,omitempty"`
	ErrMsg               string                `protobuf:"bytes,3,opt,name=errMsg,proto3" json:"errMsg,omitempty"`
	Event                *EventProto           `protobuf:"bytes,4,opt,name=event,proto3" json:"event,omitempty"`
	NotAllocated         bool                  `protobuf:"varint,5,opt,name=notAllocated,proto3" json:"notAllocated,omitempty"`
	DefFlowCheckId       int64                 `protobuf:"varint,6,opt,name=defFlowCheckId,proto3" json:"defFlowCheckId,omitempty"`
	DefFlowControlInfo   string                `protobuf:"bytes,7,opt,name=defFlowControlInfo,proto3" json:"defFlowControlInfo,omitempty"`
	GroupFlowCheckId     int64                 `protobuf:"varint,8,opt,name=groupFlowCheckId,proto3" json:"groupFlowCheckId,omitempty"`
	...
	SsdStoreId           int64                 `protobuf:"varint,10,opt,name=ssdStoreId,proto3" json:"ssdStoreId,omitempty"`
	QryPriorityId        int32                 `protobuf:"varint,11,opt,name=qryPriorityId,proto3" json:"qryPriorityId,omitempty"`
	RequireAuth          bool                  `protobuf:"varint,12,opt,name=requireAuth,proto3" json:"requireAuth,omitempty"`
	AuthorizedInfo       *MasterAuthorizedInfo `protobuf:"bytes,13,opt,name=authorizedInfo,proto3" json:"authorizedInfo,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (*HeartResponseM2C) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{21}
}
...
func (*CloseRequestB2M) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{22}
}
...
func (*CloseResponseM2B) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ede81a02fdc9715, []int{23}
}
...
func init() {
	...
	proto.RegisterType((*RegisterRequestC2M)(nil), "protocol.RegisterRequestC2M")
	proto.RegisterType((*RegisterResponseM2C)(nil), "protocol.RegisterResponseM2C")
	...
	proto.RegisterType((*HeartRequestC2M)(nil), "protocol.HeartRequestC2M")
	proto.RegisterType((*HeartResponseM2C)(nil), "protocol.HeartResponseM2C")
...
func init() { proto.RegisterFile("protocol/master.proto", fileDescriptor_8ede81a02fdc9715) }

var fileDescriptor_8ede81a02fdc9715 = []byte{
	// 1805 bytes of a gzipped FileDescriptorProto
	,
}
